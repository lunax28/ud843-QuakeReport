    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i = 0; i < length; i++){
                ...
                JSONObject propObj = arrayObj.optJSONObject("properties");

                String magnitude, location, time;

                magnitude = propObj.getString("mag");
                location = propObj.getString("place");
                time = propObj.getString("time");
