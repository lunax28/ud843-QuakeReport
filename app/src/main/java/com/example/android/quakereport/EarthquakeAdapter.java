...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (location.contains("of")) {
            ...
            String substring = location.substring(0,location.indexOf("of")+2);
            locationOffset.setText(substring);
            substring = location.substring(location.indexOf("of")+3,location.length());
            primaryLocation.setText(substring);
